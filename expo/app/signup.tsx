...
import { ChefHat, Mail, Lock, Eye, EyeOff, User } from "lucide-react-native";
...
export default function SignupScreen() {
  ...
  const isDisabled = !email.trim() || !password.trim() || isSigningUp;
    ...
    >
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>Start saving recipes</Text>
        </View>
